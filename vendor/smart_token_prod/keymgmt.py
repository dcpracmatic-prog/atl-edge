...
class InMemoryKeyProvider(KeyProvider):
    """
    Backend de referencia — mismo comportamiento que el código actual
    (sk/pk en memoria de proceso). Sin rotación real, sin control de
    acceso, sin auditoría. Válido para desarrollo y pruebas únicamente.
    """
