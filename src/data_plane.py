...
DEFAULT_MAX_RECORDS = 20  # hard cap per ATLP package (operational limit)
...
def predigest_records(
    ...
    *,
    ...
    return {"n_in": len(records), "n_out": len(rows), "fields": fields, "max_records": max_records, "rows": rows}
